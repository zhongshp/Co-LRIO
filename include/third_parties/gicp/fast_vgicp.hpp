...
#include <gicp/fast_vgicp_voxel.hpp>
...
public:
  ...
  double computeMSE(const Eigen::Matrix4d& trans)
  {
    Eigen::Isometry3d isometry(trans);
    return compute_error(isometry)/voxel_correspondences_.size();
  }
